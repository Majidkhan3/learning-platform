      ...
      if (data.success) {
        ...
        const filteredCards = data.words.filter((word) => {
          ...
          if (rating && rating !== 'All') {
            ...
            if (selectedRatings.includes('Sin calificación')) {
  ...
  const goToCard = useCallback((index) => {
    if (index >= 1 && index <= cards.length) {
      if (tag && rating) {
        ...
        router.push(`/dashboards/espagnol/flashcard?tag=${tag}&index=${index}`)
      } else if (rating) {
  ...
  if (loading)
    return (
      <Col className="text-center w-full justify-center py-5">
        ...
        <p className="text-muted">Cargando tarjetas didácticas...</p>
      </Col>
    )
      ...
      >
        <div className="flashcard-container" style={{ width: '400px' }}>
          <div className="text-center mb-2">
            <small>
              tarjeta {currentIndex} of {cards.length}
            </small>
          </div>
                ...
                <Card.Body className="d-flex flex-column h-100">
                  ...
                  <div className="mt-auto">
                    <div className="text-center mb-3">
                      <small> Toca para revelar el contenido</small>
                    </div>
                  </div>
                </Card.Body>
              </Card>
