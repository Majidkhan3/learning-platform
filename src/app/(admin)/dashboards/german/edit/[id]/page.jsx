...
const EditEspagnol = ({ params }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const wordRes = await fetch(`/api/german/gerword/${id}`, {
          headers: {
        ...
        const tagsRes = await fetch(`/api/german/gertags?userId=${userId}`, {
          headers: {
            Authorization: `Bearer ${token}`,
            'Content-Type': 'application/json',
          },
  ...
  const saveContent = async () => {
    ...
    try {
      ...
      const res = await fetch(`/api/german/gerword/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  return (
    <Row>
      <Col xl={12}>
        <Card>
          <Card.Body>
            <h2 className="mb-4">Wort bearbeiten</h2>

            {/* Word Input */}
            <Form.Group className="mb-4">
              <Form.Label><h4>Wort:</h4></Form.Label>
              <Form.Control
                type="text"
                value={formData.word}
            ...
            {/* Tags */}
            <Form.Group className="mb-4">
              <Form.Label><h4>Etiketten:</h4></Form.Label>
              ...
              <small className="text-muted">
               Klicken Sie, um Etiketten auszuwählen/abzuwählen
              </small>
            </Form.Group>

            {/* Summary */}
            <Form.Group className="mb-4">
              <Form.Label><h4>Zusammenfassung:</h4></Form.Label>
              <div
              ...
              >
                <Editor
                  ...
                  placeholder="Geben Sie hier Ihre Zusammenfassung ein..."
                />
              </div>
              <Form.Check
                type="checkbox"
                className="mt-2"
                label="Automatisch Zusammenfassung generieren"
            ...
            {/* Rating */}
            <Form.Group className="mb-4">
              <Form.Label><h4>Bewertung:</h4></Form.Label>
            ...
            <Form.Group className="mb-4">
              ...
              {formData.autoGenerateImage && (
                <small className="text-muted d-block mt-2">
                  Ein Bild wird automatisch basierend auf dem Wort generiert.
                </small>
              )}
            </Form.Group>
