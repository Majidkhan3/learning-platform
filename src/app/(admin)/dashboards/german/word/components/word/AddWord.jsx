...
const AddWord = () => {
  ...
  const fetchTags = async () => {
    try {
      setLoading(true)
      const res = await fetch(`/api/german/gertags?userId=${userId}`, {
        headers: {
  ...
  const saveContent = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/german/gerword', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
    ...
    <>
      <Row>
        <Col xl={12}>
          <Card>
            <Card.Body>
              <h2 className="mb-4">Ein neues Wort hinzufügen</h2>
              ...
              <Form.Group className="mb-4">
                ...
                <Form.Control type="text" value={formData.word} onChange={handleWordChange} placeholder="Geben Sie das Wort ein" />
              </Form.Group>
              ...
              <Form.Group className="mb-4">
                ...
                <small className="text-muted">Klicken Sie, um Tags auszuwählen/abzuwählen</small>
              </Form.Group>
              ...
              <Button variant="primary" size="lg" onClick={saveContent} disabled={loading}>
                {loading ? 'Wird gespeichert...' : 'Wort speichern'}
              </Button>
            </Card.Body>
          </Card>
        </Col>
