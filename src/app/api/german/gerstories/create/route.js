...
function generateStoryTitlePrompt(storyText) {
  return `
Based on the following story (which contains exactly two dialogues in German), generate a short title of 3 to 4 words maximum that summarizes the main topic.
