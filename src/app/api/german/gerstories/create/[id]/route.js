...
export async function GET(req, { params }) {
  ...
  try {
    ...
    const story = await Gerstories.findOne({ storyId })
...
export async function DELETE(req, { params }) {
  ...
  try {
    const deletedStory = await Gerstories.findOneAndDelete({ storyId })
...
export async function PUT(req, { params }) {
  ...
  try {
    ...
    const updatedStory = await Gerstories.findOneAndUpdate(
      { storyId },
      { title: cleanedTitle },
