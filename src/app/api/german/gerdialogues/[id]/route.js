...
export async function GET(req, { params }) {
  ...
  try {
    ...
    const dialogue = await Gerdialogue.findById(id)
    if (!dialogue) {
...
export async function DELETE(req, { params }) {
  ...
  try {
    ...
    const deletedDialogue = await Gerdialogue.findByIdAndDelete(id)
...
export async function PUT(req, { params }) {
  ...
  try {
    ...
    const updatedDialogue = await Gerdialogue.findByIdAndUpdate(
      id,
      { title: cleanedTitle },
