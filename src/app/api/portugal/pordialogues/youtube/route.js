...
function generatePrompt(transcript) {
  return `
Utilizando apenas a transcrição deste podcast, crie 8 diálogos imersivos em inglês.

Cada diálogo deve incluir:

- Uma pergunta da pessoa A.

- Uma resposta de 5 linhas da pessoa B.
...
function generateTitlePrompt(originalText, dialogues) {
  return `
A partir da transcrição e dos diálogos gerados,

crie um título curto em inglês com 3 a 4 palavras.
...
Por favor, responda APENAS com o título. Sem aspas.
`
}
