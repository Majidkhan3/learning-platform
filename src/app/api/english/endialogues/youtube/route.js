...
function generatePrompt(transcript) {
  return `
Based only on this podcast transcript, generate 8 immersive English dialogues.

Each dialogue must have:
- A question from Person A.
- A 5-line paragraph answer from Person B.
...
function generateTitlePrompt(originalText, dialogues) {
  return `
Based on the transcript and generated dialogues,
create a short 3–4 word English title.
